...
func main() {
	...
	removeBool = flag.Bool("remove", false, "Remove yulong-hids service")
	uninstallBool = flag.Bool("uninstall", false, "Remove yulong-hids service & Remove yulong-hids files")
